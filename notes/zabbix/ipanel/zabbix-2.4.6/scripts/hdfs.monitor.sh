...
#name=`curl -s http://192.168.36.100:50070/dfsnodelist.jsp?whatNodes=DEAD | grep "50075" | awk -F'[:/]' '{print $4}'`
name=`curl -s 'http://192.168.36.100:50070/dfsnodelist.jsp?whatNodes=DEAD' | grep 50075 | awk -F '[<>]' '{print $(NF-2)}'`
function transfer(){
